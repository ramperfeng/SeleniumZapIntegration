...
public class Hooks extends Utilities implements En {
    ...
    public Hooks(TestContext testContext) {
        ...
        Before((Scenario scenario) -> {
            ...
            FIS = new FileInputStream("D:\\Cucumber-Automation\\src\\main\\java\\config\\GlobalConfig.properties");
            System.out.println("global property files printed -------- ");
            ErrorProp = new FileInputStream("D:\\Cucumber-Automation\\src\\main\\java\\config\\GlobalConfig.properties");
            ENDPointProp = new FileInputStream("D:\\Cucumber-Automation\\src\\main\\resources\\test.properties");
